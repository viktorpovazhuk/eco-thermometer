...
framework-energiamsp430/libraries/LiquidCrystal/examples/setCursor/%.obj: ../framework-energiamsp430/libraries/LiquidCrystal/examples/setCursor/%.ino $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
