...
public:
    ...
    struct Settings
    {
        Settings(
            ...
            SpiEnable _se = SpiEnable_False) : tempOSR(_tosr),
                                               humOSR(_hosr),
                                               presOSR(_posr),
                                               mode(_mode),
                                               standbyTime(_st),
    ...
    bool readData(int32_t *data);

    /////////////////////////////////////////////////////////////////
    /// Copy read raw trim values from the BME280 settings.
...
private:
    ...
    static const uint8_t PRESS_DIG_ADDR_1 = 0x8E;
    static const uint8_t PRESS_DIG_ADDR_2 = 0x9C;
    ...
    static const uint8_t PRESS_DIG_LENGTH_1 = 16;
    static const uint8_t PRESS_DIG_LENGTH_2 = 2;
